Функция СведенияОВнешнейОбработке() Экспорт 
	...
	МассивНазначений.Добавить("Документ.ИзменениеСостоянияОС");
	...
	ПараметрыРегистрации.Вставить("Информация", "ЗаполнениеТЧОСПоОстаткамОсНаСкладах"); 
    ТаблицаКоманд = ПолучитьТаблицуКоманд();
	ДобавитьКоманду(ТаблицаКоманд, "Заполнение арендованных ОС", "ЗаполнениеТЧОСПоОстаткамОсНаСкладах ", "ВызовКлиентскогоМетода");

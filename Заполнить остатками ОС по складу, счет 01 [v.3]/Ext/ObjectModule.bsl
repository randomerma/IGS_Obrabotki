Функция СведенияОВнешнейОбработке() Экспорт 
	...
	МассивНазначений.Добавить("Документ.ИнвентаризацияОС.ОС");                                                                //Указываем документ к которому делаем внешнюю печ. форму
	...
	ПараметрыРегистрации.Вставить("Наименование", "Заполнение табличной части инвентаризации основных средств (ОС)"); //имя под которым обработка будет зарегестрирована в справочнике внешних обработок
	...
	ДобавитьКоманду(ТаблицаКоманд, "Заполнить по остаткам 01 счета", "ЗаполнитьОС", "ВызовКлиентскогоМетода");

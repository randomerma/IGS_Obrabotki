Функция СведенияОВнешнейОбработке() Экспорт     
	...
	ПараметрыРегистрации.Вставить("Наименование", "Инвентаризация товаров на складе выбор"); 
	ПараметрыРегистрации.Вставить("БезопасныйРежим", ЛОЖЬ);
	ПараметрыРегистрации.Вставить("Версия", "1.0"); 
	ПараметрыРегистрации.Вставить("Информация", ""); 
	ТаблицаКоманд = ПолучитьТаблицуКоманд();
	ДобавитьКоманду(ТаблицаКоманд, "Инвентаризация товаров на складе выбор", "ИнвентаризацияТоваровНаСкладе", "открытиеФормы", Истина, "ПечатьMXL");

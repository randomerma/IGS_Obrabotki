...
Процедура Печать(МассивОбъектов, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	ФиналТабДокумент.ИмяПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_СличительнаяВедомостьБуровыхИКомплектующих";
	...
	КонецЦикла;
	УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм,"ПАРАМЕТРЫ_ПЕЧАТИ_СличительнаяВедомостьБуровыхИКомплектующих","Сличительная ведомость буровых и комплектующих",ТабДокумент);
КонецПроцедуры      
